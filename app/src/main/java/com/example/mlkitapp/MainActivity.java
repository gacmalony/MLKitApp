...
public class MainActivity extends AppCompatActivity {
    ...
    MaterialButton img_btn, spc_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_btn = findViewById(R.id.image);
        spc_btn = findViewById(R.id.speech);
        ...
        spc_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                textToSpeech.speak(textview.getText().toString(), textToSpeech.QUEUE_FLUSH, null);
                Toast.makeText(getApplicationContext(), "Whats happening here", Toast.LENGTH_SHORT).show();
            }
        });
                                    ...
                                    .addOnFailureListener(
                                            new OnFailureListener() {
                                                ...
                                                public void onFailure(@NonNull Exception e) {
                                                    e.printStackTrace();
                                                    Toast.makeText(getApplicationContext(), "Dumb, there is a mistake", Toast.LENGTH_SHORT).show();
                                                }
                                            });
